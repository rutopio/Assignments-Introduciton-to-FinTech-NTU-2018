...
def myStrategy(pastData, currPrice):
    ...
    # 當下的MA長線值
    ma_long  = (talib.MA(pastData, timeperiod = ma_long_day, matype = ma_long_type))[-1]
    # 當下的MA短線值
    ma_short = (talib.MA(pastData, timeperiod = ma_short_day, matype = ma_short_type))[-1]
    # 當下的RSI值
    rsi_current = (talib.RSI(pastData, timeperiod = rsi_day))[-1]    
